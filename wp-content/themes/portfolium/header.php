    ...
    <body>
        <div class="wrapper">
            <div class="header clear">
                <div id="logo">
                    <div class="head"></div>
                    <div class="lines" style="top: -601px"></div>
                </div>
            ...
            <?php if ( is_home() ) : ?>
                <div class="billboard clear">
                    <h1><em>Brain Drain</em> is the antidote to urban exodus. Representing young natives and transplants that call St. Louis City home, our projects revere the city’s unique heritage while catalyzing its future. We focus on community-based projects that enhance the vitality of the larger St. Louis region and turn shared experience into shared initiative for our city.</h1>
                </div>
            <?php endif; ?>
